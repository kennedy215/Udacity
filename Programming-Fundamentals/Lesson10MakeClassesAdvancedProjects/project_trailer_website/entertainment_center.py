...
"""
    ...
    Each movie (movie is the Parent) below is organized into title,
    storyline, poster image, movie trailer.
    Each series (series is the Child) along with the movie attributes
    series contain seasons and episodes.
    I got rid of  # noqa because it appeared on the final page.
"""

night_of_the_demons = mediab.Movie("Night of the Demons",
                                   """College students throw a Halloween party in an
                                   abandoned house only to
                                   receive a nice treat!""",
...
pet_semetary = mediab.Movie("Pet Semetary",
                            """Father loses his son and brings him back
                            from the dead. But is it his son?""",
...
stranger_things = mediab.Series("Stranger Things",
                                """A kid is missing and his friends discover
                                it's because of a secret government project""",
...
nightmare_on_elmstreet = mediab.Movie("Nightmare on Elmstreet",
                                      """A serial killer exacts revenge on the children
...
demons = mediab.Movie("Demons",
                      """People are invited to see a movie premiere named,
                      'Demons'only to find out it isn't a movie!""",
...
deathgasm = mediab.Movie("Deathgasm",
                         """Nerds, Heavy Metal and cursed music that
                         brings about demons creates? A bad ass movie!""",
...
childs_play = mediab.Movie("Child's Play",
                           """A boy's good guy doll is possessed
                           by a dead serial killer""",
...
return_of_the_living_dead = mediab.Movie("Return of the Living Dead",
                                         """Young and bored a group of
                                         friends decides
                                         to throw a part in the cemetary
                                         only to find
                                         out the dead is rising!""",
...
movies = [night_of_the_demons, pet_semetary,
          stranger_things, tales_from_the_crypt, tales_from_the_darkside,
          nightmare_on_elmstreet, demons, deathgasm, childs_play,
